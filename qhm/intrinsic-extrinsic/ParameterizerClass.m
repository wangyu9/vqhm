classdef ParameterizerClass < matlab.mixin.Copyable
    ...
    properties
        ...
        EnergyType
        %
        t_max = 1.0 % wangyu added to allow larger step size, 1.0 is the one used by CM paper. 
    ...
    methods
        ...
        function SetEnergyType(obj,Type)
            ...
            switch obj.EnergyType
                case 'Sym-Dirichlet'
                    obj.ProxyTypesList = {'Composite Majorization','SLIM','Projected Newton', 'Full projected Newton','Newton','Temp'};
        ...
        function [t,stepSize,f_new] = DoLineSearch(obj,x,p,f,g)
            ...
            t = min(obj.c_linesearch*stepSize,obj.t_max);
