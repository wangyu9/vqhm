function varargout = simple_deform_complex(varargin)
...
%         hold off;
  ...
  function update_positions()
    ...
    elseif(strcmp(interp_mode,'CLI'))
      ...
      % linear blend skinning
      %[new_V] = lbs(V(:,1:2),TR,W);
      CP = g_Deform(gid).new_C(P,:);%wangyu
      new_V = W*[CP(:,1)+1i*CP(:,2)];
      new_V = [real(new_V),imag(new_V)];
